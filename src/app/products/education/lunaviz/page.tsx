...
export default function LunaVizPage() {
  return (
    <>
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-pink-950 via-purple-900 to-indigo-950 py-20 sm:py-28">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -left-1/4 -top-1/4 h-96 w-96 rounded-full bg-pink-500/20 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            <div className="flex flex-col justify-center">
              ...
              <p className="mt-2 text-xl font-medium text-pink-200">
      ...
      {/* CTA */}
      <section className="bg-gradient-to-br from-pink-900 to-purple-900 py-16 sm:py-24">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white sm:text-4xl">
            Ready to Transform Your Classroom?
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-pink-100/90">
